...
class VersionProjectPercentRanges extends AbstractMigration
{
    public function up(Schema $schema)
    {
        $this->abortIf($this->connection->getDatabasePlatform()->getName() != 'mysql', 'Migration can only be executed safely on \'mysql\'.');
        
        $this->addSql('ALTER TABLE project ADD min_percent INT DEFAULT NULL, ADD max_percent INT DEFAULT NULL');
    }
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE project DROP min_percent, DROP max_percent');
    }
}
