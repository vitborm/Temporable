...
class ProjectAdmin extends Admin
{
    protected function configureShowField(ShowMapper $showMapper)
    {
        $showMapper
            ...
            ->add('actual', null, ['label' => 'Актуальный'])
            ->add('minPercent', null, ['label' => 'Минимальный процент времени'])
            ->add('maxPercent', null, ['label' => 'Максимальный процент времени'])
        ;
    }
    ...
    protected function configureFormFields(FormMapper $formMapper)
    {
        $formMapper
            ->add('name', null, ['label' => 'Название'])
            ->add('actual', null, ['label' => 'Актуальный', 'required' => false])
            ->add('minPercent', null, ['label' => 'Минимальный процент времени'])
            ->add('maxPercent', null, ['label' => 'Максимальный процент времени'])
        ;
    }
